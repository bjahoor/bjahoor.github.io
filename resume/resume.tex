...
\begin{minipage}[t]{0.56\textwidth}
  \vspace{0pt}
  \textbf{\fontsize{27.67}{27.67}\selectfont \scshape \color{uwpurple}Brandon Jahoor}\\[0.3pt]
...
\begin{minipage}[t]{0.42\textwidth}
  \vspace{0pt}
  % Four links in a 2x2 grid rather than a column, so the block stays as wide
  % as three lines did but only needs two. Rows are spread with \\[..] to keep
  % the block bottoming out level with the tagline opposite.
  \raggedleft \fontsize{8}{8}\selectfont
  \begin{tabular}{@{}r@{\hspace{16pt}}r@{}}
    {\color{uwpurple}\faEnvelope\ \href{mailto:bjahoor@uwaterloo.ca}{\underline{bjahoor@uwaterloo.ca}}} &
    {\color{uwpurple}\faLinkedin\ \href{https://linkedin.com/in/bjahoor}{\underline{linkedin.com/in/bjahoor}}} \\[16pt]
...
Engineering Honours, Minor in \href{https://uwaterloo.ca/academic-calendar/undergraduate-studies/catalog\#/programs/Hye0Jk00ih?group=Options\%3A\%20Faculty\%20of\%20Engineering&bc=true&bcCurrent=Artificial\%20Intelligence\%20Option&bcGroup=Options\%3A\%20Faculty\%20of\%20Engineering&bcItemType=programs}{\color{uwpurple}\underline{Artificial Intelligence}}} \hfill \textit{2028}}
\vspace{2pt}
